...
export function organizationSchema() {
  return {
    ...
    name: SITE.name,
    url: absoluteUrl("/"),
    // The site OG image is generated by Next's file-convention
    // (app/opengraph-image.tsx) and our postbuild script renames it to
    // opengraph-image.png, so this is a real, served asset.
    logo: absoluteUrl("/opengraph-image.png"),
    // Real external profile that disambiguates the brand for crawlers.
    // We only list links we actually own — placeholders here would
    // poison knowledge-graph signals.
    sameAs: ["https://github.com/SonuSharmaFiles/toollyz"],
  };
}
